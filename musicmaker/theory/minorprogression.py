...
class MinorProgression(ProgressionGraph):
    position_dict = {
        ...
        '#ivdim7':    ProgressionGraph.Position('#ivdim7', 4, 'dim7', [], 1),
        ...
        'bIII':       ProgressionGraph.Position('bIII', 3, '', ['7', '9', 'Mb9no7'], -1),
        'bviim7b5':   ProgressionGraph.Position('bviim7b5', 7, 'm7b5', [], -1),
